...
/** Funkce generate2D(filters, radius, samples, length) */
...
/**	 Zkratka k funkci generate2D, ktera vytvari LBP filtry r = 1 , s = 8 */
...
/**	 Zkratka k funkci generate2D, ktera vytvari LBP filtry r = 1 , s = 4 */
